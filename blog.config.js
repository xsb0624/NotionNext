...
const BLOG = {
  ...
  AUTHOR: process.env.NEXT_PUBLIC_AUTHOR || '阿飞', // 您的昵称 例如 tangly1024
  BIO: process.env.NEXT_PUBLIC_BIO || '阿飞的博客', // 作者简介
  LINK: process.env.NEXT_PUBLIC_LINK || 'https://xiongfei.vip', // 网站地址
  ...
  BEI_AN: process.env.NEXT_PUBLIC_BEI_AN || '浙ICP备20028132号', // 备案号 闽ICP备XXXXXXX
